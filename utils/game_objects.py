...
from utils.yield_resolver import must_yield
from utils.motion import move_polar
...
def load_image(name):
    # TODO: Memoize the image on application-level;
    # currently, the images are constantly being reloaded from disk
    # Can do by making this a method of GameObject,
    # then setting param on the app: <GameObject instance>.app
